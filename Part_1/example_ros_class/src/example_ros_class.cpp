//example_ros_class.cpp:illustrates how to use classes to make ROS nodes
...
void ExampleRosClass::subscriberCallback(const std_msgs::Float32& message_holder) {
    // the real work is done in this callback function. it wakes up every time a new message is published on "exampleMinimalSubTopic"
